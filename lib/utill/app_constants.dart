import 'package:handies/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'Handy';
  static const String APP_VERSION = '13.1';
  static const String BASE_URL = 'https://handies.app';
  ...
  static const String MESSAGES_URI = '/api/v1/customer/chat/get-messages/';
  static const String CHAT_INFO_URI = '/api/v1/customer/chat/list/';
  ...
  static const String DELIVERY_RESTRICTED_COUNTY_LIST =
      '/api/v1/customer/get-restricted-country-list';
  static const String DELIVERY_RESTRICTED_ZIP_LIST =
      '/api/v1/customer/get-restricted-zip-list';
  static const String GET_ORDER_FROM_ORDER_ID =
      '/api/v1/customer/order/get-order-by-id?order_id=';
  static const String OFFLINE_PAYMENT =
