...
import 'package:handies/data/model/response/cart_model.dart';
import 'package:handies/data/model/response/product_details_model.dart' as pd;
import 'package:handies/data/model/response/product_model.dart';
import 'package:handies/helper/price_converter.dart';
...
import 'package:handies/view/basewidget/button/custom_button.dart';
          ...
          child: Consumer<ProductDetailsProvider>(
            builder: (ctx, details, child) {
              ...
              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: FadeInImage.assetNetwork(
                            ...
                            image: (widget.product.colors != null && widget.product.colors.length > 0 ) ?
                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Text(widget.product.name ?? '',
                              ...
                              SizedBox(height: widget.product.taxModel == "include" ? Dimensions.PADDING_SIZE_SMALL:0),
                ...
                (widget.product.colors != null && widget.product.colors.length > 0) ? SizedBox(height: Dimensions.PADDING_SIZE_SMALL) : SizedBox(),
                ...
                Row(children: [
                  ...
                  Expanded(
                    child: CustomButton(buttonText: getTranslated(_stock < widget.product.minimumOrderQty && widget.product.productType == "physical"?
                        ...
                        onTap: _stock < widget.product.minimumOrderQty  &&  widget.product.productType == "physical" ? null :() {
                          if(_stock >= widget.product.minimumOrderQty  || widget.product.productType == "digital") {
                            CartModel cart = CartModel(
                                ...
                                _variation, widget.product.discount, widget.product.discountType, widget.product.tax, widget.product.taxModel,
                  ...
                  Provider.of<CartProvider>(context, listen: false).addToCartLoading ? SizedBox() :
                  Expanded(
                    child: CustomButton(isBuy:true,
                        buttonText: getTranslated(_stock < widget.product.minimumOrderQty && widget.product.productType == "physical" ? 'out_of_stock' : 'buy_now', context),
                        onTap: _stock < widget.product.minimumOrderQty  && widget.product.productType == "physical" ? null :() {
                          if(_stock >= widget.product.minimumOrderQty || widget.product.productType == "digital") {
                            CartModel cart = CartModel(
                                widget.product.id,widget.product.id, widget.product.thumbnail, widget.product.name,
