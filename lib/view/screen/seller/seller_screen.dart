...
import 'package:handies/view/basewidget/search_widget.dart';
import 'package:handies/view/screen/chat/chat_screen.dart';
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                if (widget.seller.seller.about != null &&
                    widget.seller.seller.about != "") ...[
                  SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                  Container(
                      color: Theme.of(context).highlightColor,
                      padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          Text(widget.seller.seller.about),
                        ],
                      )),
                ],
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
